  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content={pageDescriptions[currentLanguage]} />
        ...
        <meta name="twitter:description" content={pageDescriptions[currentLanguage]} />
        <meta name="twitter:image" content="https://videosoundevents.com/og-image.jpg" />
      </Helmet>

      <main className="container py-12" aria-label={pageTitles[currentLanguage]}>
